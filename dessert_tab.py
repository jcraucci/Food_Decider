...
class Dessert:
    def __init__(self, dessert_frame):
        self.dessert_frame = dessert_frame
        self.data_file = "dessert.txt"
        ...
        # Main container
        self.main_frame = ttk.Frame(self.dessert_frame, padding=10)
        self.main_frame.grid(row=0, column=0, sticky="nsew")

        self.dessert_frame.columnconfigure(0, weight=1)
        self.dessert_frame.rowconfigure(0, weight=1)
    ...
    def load_recipes(self):
        """Load recipes from dessert.txt if it exists."""
        ...
        try:
            ...
            messagebox.showwarning(
                "Load Error",
                "Could not read dessert.txt. Starting with an empty recipe list."
            )
            self.recipes = []

    def save_recipes(self):
        """Write the current recipe list to dessert.txt."""
        try:
            ...
            messagebox.showerror(
                "Save Error",
                "Could not save recipes to dessert.txt."
            )
