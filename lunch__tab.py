...
class Lunch:
    def __init__(self, lunch_frame):
        self.lunch_frame = lunch_frame
        self.data_file = "lunch.txt"
        ...
        # Main container
        self.main_frame = ttk.Frame(self.lunch_frame, padding=10)
        self.main_frame.grid(row=0, column=0, sticky="nsew")

        self.lunch_frame.columnconfigure(0, weight=1)
        self.lunch_frame.rowconfigure(0, weight=1)
    ...
    def load_recipes(self):
        """Load recipes from lunch.txt if it exists."""
        ...
        try:
            ...
            messagebox.showwarning(
                "Load Error",
                "Could not read lunch.txt. Starting with an empty recipe list."
            )
            self.recipes = []

    def save_recipes(self):
        """Write the current recipe list to lunch.txt."""
        try:
            ...
            messagebox.showerror(
                "Save Error",
                "Could not save recipes to lunch.txt."
            )
