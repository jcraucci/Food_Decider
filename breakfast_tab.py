...
class Breakfast:
    def __init__(self, breakfast_frame):
        self.breakfast_frame = breakfast_frame
        self.data_file = "breakfast.txt"
        ...
        # Main container
        self.main_frame = ttk.Frame(self.breakfast_frame, padding=10)
        self.main_frame.grid(row=0, column=0, sticky="nsew")

        self.breakfast_frame.columnconfigure(0, weight=1)
        self.breakfast_frame.rowconfigure(0, weight=1)
    ...
    def load_recipes(self):
        """Load recipes from breakfast.txt if it exists."""
        ...
        try:
            ...
            messagebox.showwarning(
                "Load Error",
                "Could not read breakfast.txt. Starting with an empty recipe list."
            )
            self.recipes = []

    def save_recipes(self):
        """Write the current recipe list to breakfast.txt."""
        try:
            ...
            messagebox.showerror(
                "Save Error",
                "Could not save recipes to breakfast.txt."
            )
